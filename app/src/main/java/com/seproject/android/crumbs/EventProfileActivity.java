...
public class EventProfileActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_profile_layout);
        ...
        /* Calling Feature */
        callText = (TextView) findViewById(R.id.text_call_number);
        number = callText.getText().toString().trim();
