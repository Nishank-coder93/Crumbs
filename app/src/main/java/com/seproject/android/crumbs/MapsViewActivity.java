...
public class MapsViewActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private static final LatLng UC1 = new LatLng(40.7316535, -87.11099790000003);
    private Marker mUC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Cart Button initialisation
        cartButton = (Button) findViewById(R.id.cartTab);
        cartButton.setOnClickListener(this);

        //Setting button
        settingButton = (Button) findViewById(R.id.settingTab);
    ...
    public void addListenerOnButton() {
        ...
        button = (Button) findViewById(R.id.foodTab);
    ...
    //Search function
    //Address from text view is being used to point to a marker. We can use this in our maps to point to seller markers
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("currentposition Page") // TODO: Define a title for the content shown.
